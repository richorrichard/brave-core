...
void Confirmations::Confirm(const std::string& transaction_id,
  ...
  BLOG(1, "Confirming " << std::string(confirmation_type) << " for "
                        << std::string(ad_type) << " with transaction id "
                        << transaction_id << " and creative instance id "
