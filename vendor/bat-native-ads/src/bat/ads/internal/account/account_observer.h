...
class AccountObserver : public base::CheckedObserver {
 public:
  ...
  // Invoked when funds are deposited for |creative_instance_id|, |ad_type| and
  // |transaction|
  virtual void OnDepositedFunds(const std::string& creative_instance_id,
                                const AdType& ad_type,
                                const TransactionInfo& transaction) {}

  // Invoked when funds failed to deposit for |creative_instance_id|, |ad_type|
  // and |transaction|
