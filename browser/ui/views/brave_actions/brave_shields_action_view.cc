...
class BraveShieldsActionViewHighlightPathGenerator
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(BraveShieldsActionViewHighlightPathGenerator);
};

}  // namespace

BraveShieldsActionView::BraveShieldsActionView(
    BraveShieldsActionView::Delegate* delegate)
...
gfx::Size BraveShieldsActionView::CalculatePreferredSize() const {
