      ...
      case 'kycRequiredModal':
        return (
          <ModalRedirect
            ...
            errorText={getLocale('redirectModalKYCRequiredText').replace('$0', getWalletProviderName(externalWallet))}
      ...
      case 'mismatchedProviderAccountsModal':
        return (
          <ModalRedirect
            ...
            errorText={getLocale('redirectModalMismatchedProviderAccountsText').replace('$0', getWalletProviderName(externalWallet))}
      ...
      case 'walletOwnershipVerificationFailureModal':
        return (
          <ModalRedirect
            ...
            errorText={getLocale('redirectModalWalletOwnershipVerificationFailureText').replace('$0', getWalletProviderName(externalWallet))}
