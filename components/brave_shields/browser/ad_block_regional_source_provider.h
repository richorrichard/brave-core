...
// TODO finally move adblock::FilterList to somewhere else
...
class AdBlockRegionalSourceProvider : public SourceProvider {
 public:
  AdBlockRegionalSourceProvider(component_updater::ComponentUpdateService* cus, const adblock::FilterList& catalog_entry);
 ...
 private:
  ...
  AdBlockRegionalSourceProvider& operator=(const AdBlockRegionalSourceProvider&) = delete;
};
