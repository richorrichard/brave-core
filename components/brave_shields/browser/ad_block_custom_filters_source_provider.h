...
class AdBlockCustomFiltersSourceProvider : public SourceProvider {
 public:
  AdBlockCustomFiltersSourceProvider(PrefService* local_state);
 ...
 private:
  ...
  AdBlockCustomFiltersSourceProvider(const AdBlockCustomFiltersSourceProvider&) = delete;
  AdBlockCustomFiltersSourceProvider& operator=(const AdBlockCustomFiltersSourceProvider&) = delete;
};
