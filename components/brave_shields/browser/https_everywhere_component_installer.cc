...
base::FilePath HTTPSEverywhereComponentInstallerPolicy::
...
void RegisterHTTPSEverywhereComponent(
  ...
  auto installer = base::MakeRefCounted<component_updater::ComponentInstaller>(
      std::make_unique<HTTPSEverywhereComponentInstallerPolicy>(
          kHTTPSEverywhereComponentBase64PublicKey, kHTTPSEverywhereComponentId, kHTTPSEverywhereComponentName,
          callback));
  installer->Register(cus, base::BindOnce(&OnRegistered, kHTTPSEverywhereComponentId));
}
