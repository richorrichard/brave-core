 ...
 public:
  class Observer : public base::CheckedObserver {
   public:
    ...
    virtual void OnNewListSourceAvailable(const DATFileDataBuffer& list_source) = 0;
  };
  ...
  virtual void Load(base::OnceCallback<void(bool deserialize, const DATFileDataBuffer& dat_buf)>) = 0;
