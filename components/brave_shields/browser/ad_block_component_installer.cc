...
AdBlockComponentInstallerPolicy::
~AdBlockComponentInstallerPolicy() = default;
...
base::FilePath AdBlockComponentInstallerPolicy::
...
void RegisterAdBlockDefaultComponent(
  ...
  auto installer = base::MakeRefCounted<component_updater::ComponentInstaller>(
      std::make_unique<AdBlockComponentInstallerPolicy>(
          kAdBlockComponentBase64PublicKey, kAdBlockComponentId, kAdBlockComponentName,
          callback));
